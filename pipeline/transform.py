...
class Transform(luigi.Task):
    ...
    def run(self):
        ...
        try:
            ...
            fct_order_activity_query = read_sql_file(
                file_path = f'{DIR_TRANSFORM_QUERY}/fct_order_activity.sql'
            )
        ...
        try:
            ...
            # Transform to final.fct_order_activity
            query = sqlalchemy.text(fct_order_activity_query)
            session.execute(query)
            logging.info("Transform to 'final.fct_order_activity' - SUCCESS")
